...
#define ST7735_CS_LOW 			gpio_bit_reset(ST7735_CS_PORT, ST7735_CS_PIN);
#define ST7735_CS_HIGH 			gpio_bit_set(ST7735_CS_PORT, ST7735_CS_PIN);

#define ST7735_DC_LOW 			gpio_bit_reset(ST7735_DC_PORT, ST7735_DC_PIN);
#define ST7735_DC_HIGH 			gpio_bit_set(ST7735_DC_PORT, ST7735_DC_PIN);

#define ST7735_RST_LOW 			gpio_bit_reset(ST7735_RST_PORT, ST7735_RST_PIN);
#define ST7735_RST_HIGH 		gpio_bit_set(ST7735_RST_PORT, ST7735_RST_PIN);

#define ST7735_DELAY_MS			delay_1ms
